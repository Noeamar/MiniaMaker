...
4. Exécutez cette migration SQL :

```sql
-- Fix free plan limits: Lite = 3, Pro = 0
...
## Option 2 : Réparer l'historique puis push

```bash
supabase migration repair --status reverted 20251210082309
supabase db push
```
