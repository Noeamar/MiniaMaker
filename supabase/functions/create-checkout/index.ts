...
// Stripe price IDs
const PRICE_IDS = {
  starter: "price_1ScijtDiBRcbS7TeKY2lvajf",
  pro: "price_1ScikDDiBRcbS7Tee34khDuH",
  unlimited: "price_1ScikTDiBRcbS7Te2LNm5Pft"
};
...
serve(async (req) => {
  ...
  try {
    ...
    console.log("[CREATE-CHECKOUT] Starting for plan:", plan);
