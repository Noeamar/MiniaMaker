-- Fix free plan Pro model limit to 0 (no access)
-- Update check_generation_limit function to set Pro limit to 0 for free plan
...
BEGIN
  ...
  -- For free plan Pro model, limit is 0 so always return not allowed
